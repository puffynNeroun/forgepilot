...
import { getDashboardOverviewData } from "../../lib/db/dashboard";
    ...
    return (
      <main className="min-h-screen bg-slate-950 px-6 py-10 text-slate-100">
        <div className="mx-auto max-w-3xl rounded-3xl border border-rose-500/30 bg-rose-500/10 p-8">
          ...
          <h1 className="mt-6 text-3xl font-semibold text-white">Dashboard unavailable</h1>
          <p className="mt-4 text-sm leading-6 text-rose-100/90">
            ForgePilot could not load dashboard summary data from the local database.
          </p>
